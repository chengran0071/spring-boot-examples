package com.wxblockchain.com.learning.threadlearning;
...
public class ThreadLearning extends  Thread{
    ...
    public void lockPhoneNum(String str) throws InterruptedException {
        synchronized (str){
            System.out.println("当前数据获得锁："+str);
            Thread.sleep(1000);
            System.out.println("当前数据释放锁：" + str);
        }
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        new Thread(()-> {
            try {
                threadLearning.lockPhoneNum("123");
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        }).start();
        new Thread(()-> {
            try {
                threadLearning.lockPhoneNum("111");
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        }).start();
